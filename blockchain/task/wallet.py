...
class Wallet:
    ...
    def metaMask_Login(self, Num, dbName):
        ...
        time.sleep(3)
        try:
            self.driver.wait.wait_visibility_of_element_t(By.XPATH, '//div[@class="spinner loading-overlay__spinner"]', 3)
            self.driver.element.click_t(By.XPATH, '//button[@class="button btn--rounded btn-secondary"]', 20)
            self.driver.element.click("//span[text()='Ethereum Mainnet']")
            time.sleep(2)
        except BaseException:
            pass
        try:
            self.driver.wait.wait_visibility_of_element('//*[@id="password"]')
            self.driver.element.send_keys('//*[@id="password"]', password)
        except BaseException:
            self.driver.browser.refresh()
            self.driver.element.send_keys_t(By.XPATH, '//*[@id="password"]', password, 5)
        time.sleep(2)
        self.driver.element.click('//button[@data-testid="unlock-submit"]')
    ...
    def metaMask_FirstSign(self):
        ...
        try:
            self.driver.element.click_t(By.XPATH, "//button[@class='button btn--rounded btn-primary']", 3)
            time.sleep(2)
            self.driver.element.click('//button[@data-testid="page-container-footer-next"]')
        except BaseException:
            self.driver.element.click_t(By.XPATH, '//button[@data-testid="request-signature__sign"]', 3)
        self.driver.browser.windows_handles()

    def metaMask_AddNetWork(self):
        self.driver.browser.windows_wallet()
        self.driver.element.click("//button[@class='button btn--rounded btn-primary']")
        time.sleep(2)
        self.driver.element.click("//button[@class='button btn--rounded btn-primary']")
        time.sleep(5)
        self.driver.browser.windows_handles()
    ...
    def metaMask_Sign(self):
        ...
        try:
            ...
            pass
        try:
            self.driver.element.click_t(By.XPATH, '//button[@data-testid="page-container-footer-next"]', 3)
        except BaseException:
            pass
        try:
            self.driver.element.click_t(By.XPATH, '//button[@data-testid="request-signature__sign"]', 3)
    ...
    def metaMask_downSign(self):
        self.driver.browser.windows_wallet()
        self.driver.element.click('//*[@class="fa fa-arrow-down"]')
        time.sleep(2)
        self.driver.element.click('//button[@data-testid="page-container-footer-next"]')
        time.sleep(2)
        self.driver.browser.windows_handles()
    ...
    def metaMask_SwitchNetWork(self):
        ...
        time.sleep(3)
        try:
            self.driver.element.click_t(By.XPATH, '(//i[@role="button"])[1]', 3)
            time.sleep(1)
            self.driver.element.click('(//i[@role="button"])[1]')
        except BaseException:
            pass
        try:
            self.driver.element.click_t(By.XPATH, "//button[text()='Approve']", 3)
            time.sleep(1)
        except BaseException:
            pass
        self.driver.element.click_t(By.XPATH, '//button[@class="button btn--rounded btn-primary"]', 3)
    ...
    def metaMask_Empower(self):
        self.driver.browser.windows_wallet()
        self.driver.function.wait_and_click_button("//button[text()='Confirm']")
        time.sleep(5)
        self.driver.browser.windows_handles()
    ...
    def metaMask_Submit(self):
        self.driver.browser.windows_wallet()
        try:
            self.driver.element.click_t(By.XPATH, "//button[text()='Got it']", 3)
        except BaseException:
            pass
    ...
    def metaMask_Submit_custom(self):
        self.driver.browser.windows_wallet()
        self.driver.element.click("//span[text()='Max']")
        self.driver.element.click_t(By.XPATH, '//button[@data-testid="page-container-footer-next"]', 3)
        self.driver.element.click_t(By.XPATH, '//button[@data-testid="page-container-footer-next"]', 3)
        time.sleep(2)
        self.driver.browser.windows_handles()
    ...
    def metaMask_Submit_sendCustom(self):
        self.driver.browser.windows_wallet()
        time.sleep(2)
        self.driver.element.send_keys('//input[@placeholder="Enter a number"]', 4)
        self.driver.element.click_t(By.XPATH, '//button[@data-testid="page-container-footer-next"]', 3)
        self.driver.element.click_t(By.XPATH, '//button[@data-testid="page-container-footer-next"]', 3)
        time.sleep(2)
        self.driver.browser.windows_handles()
    ...
    def metamask_List(self, adsNum, dbName, value):
        try:
            ...
            pass
        time.sleep(3)
        self.driver.element.click('//div[@data-testid="network-display"]')
        self.driver.function.find_location('network-name-item', value)

    def suiWallet(self):
        password = self.driver.config.password()
        self.driver.browser.windows_wallet()
        try:
            self.driver.element.send_keys_t(By.XPATH, '//*[@id="root"]/div/div/div[2]/main/div/form/label/input', 3, password)
            time.sleep(5)
    ...
    def petraWallet(self):
        ...
        self.driver.browser.windows_wallet()
        try:
            self.driver.element.send_keys_t(By.XPATH, '//*[@id="field-:r1:"]', 3, password)
            time.sleep(1)
            self.driver.element.click("//button[text()='Unlock']")
        except BaseException:
            pass
        time.sleep(3)
        self.driver.function.wait_and_click_button("//button[text()='Approve']")
        time.sleep(5)
        self.driver.browser.windows_handles()
    ...
    def fuel_wallet(self):
        self.driver.browser.windows_wallet()
        self.driver.function.wait_and_click_button("//button[text()='Connect']")
        time.sleep(5)
        self.driver.browser.windows_handles()
    ...
    def fuel_wallet_sign(self):
        password = self.driver.config.password()
        self.driver.browser.windows_wallet()
        self.driver.function.wait_and_click_button("//button[text()='Sign']")
        time.sleep(1)
    ...
    def batch_transfer(self):
        all_adsNum = self.driver.config.all_ads()
        for i in range(34, len(all_adsNum) + 1):
            ...
            time.sleep(2)
            address = self.driver.config.adsAddress(i)
    ...
    def checkToken(self, Num, dbName):
        ...
        self.driver.element.click('//div[@class="identicon__address-wrapper"]')
        self.driver.element.click("//div[text()='Settings']")
        self.driver.element.click("//div[text()='Security & privacy']")
        try:
            self.driver.element.click('//label[@class="toggle-button toggle-button--off"]')
            time.sleep(2)
        except BaseException:
            print(str(Num) + '失败')
